...
def main():
    ...
    for key in meta_dict:
        ...
        video_path = os.path.join(raw_video_dir, key.replace("set3/", ""))
        ...
        ffmpeg_process(
            ...
            output_video_path = os.path.join(output_dir, key.replace("set3/", "")),
            output_audio_path = os.path.join(output_dir, key.replace("set3/", "").replace(".mp4", ".wav")),
            output_ref_path = os.path.join(output_dir, key.replace("set3/", "").replace(".mp4", ".jpg")),
        )
